...
// STEP 5 Take the 3 of the 9 variables that you created above and demonstrate 3 ways for declaring and assigning values to those variables
    ...
    // WAY 2
    //let firstName = "Olena";
    //let lastName = "Zheliabina";
    //let mayWeContactYou = true;

    //WAY 3
    //let firstName = "Olena", lastName = "Zheliabina", mayWeContactYou = rtue;

// STEP 6 Create a variable. Add a number and a string and display the coerced result in the browser’s console window.
    //let favoriteNumber = "My favorite Number is " + 7; 
    //window.console.log (favoriteNumber);
...
// STEP 7 Create two variables. For the first variable, add a Boolean and a string and display the coerced result. For the second variable, add a number and a Boolean and display the coerced result. 
    //let mayWeContactYou = "May we contact you? " + true;
    //window.console.log (mayWeContactYou);

    //let myFavoriteNumber = 7 + true;
    //window.console.log (myFavoriteNumber);
...
// STEP 10
    //let firstName = "Olena";
    //let numPhone = 555-55-55;
    //let isStudent = true;
    //let car = new Object();
    //let myVariable;
    //window.console.log(typeof firstName);
    //window.console.log(typeof numPhone);
    //window.console.log(typeof isStudent);
...
// STEP 11 Within an alert box, use the concatenation operator (+) to display text in the alert box that appears as follows: Hello Zak Ruvalcaba, welcome to the JavaScript class!
    //window.alert("Hello " + "Olena Zheliabina" + ", welcome to the JavaScript class!");
